...
MONGODB_CONNECTION_STRING = 'mongodb+srv://test:sparta@cluster0.5qv8bta.mongodb.net/?retryWrites=true&w=majority'
...
def home():
    ...
    try:
        ...
        return redirect(url_for("login", msg="Maaf, token anda sudah kadaluarsa.."))
    except jwt.exceptions.DecodeError:
        return redirect(url_for("login", msg="Maaf Terjadi masalah ketika Login!"))
...
def sign_in():
    ...
    # password combination cannot be found
        ...
        return jsonify(
            {
                "result": "gagal",
                "msg": "Maaf, Kami tidak dapat menemukan pengguna dengan kombinasi id/kata sandi tersebut..",
            }
        )
...
def save_img():
    ...
    try:
        ...
        return jsonify({"result": "success", "msg": "Profile Berhasil diUpdated!"})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
...
def posting():
    ...
    try:
        ...
        return jsonify({"result": "success", "msg": "Postingan berhasil dibuat!"})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
